...
extension NSAttributedString {
    private func hasFontAttribute() -> Bool {
        guard !string.isEmpty else { return false }
        let font = attribute(.font, at: 0, effectiveRange: nil) as? UIFont
        return font != nil
    }

    fileprivate func copyWithParagraphAttribute(_ font: UIFont) -> NSAttributedString {
    ...
    fileprivate func copyWithAddedFontAttribute(_ font: UIFont) -> NSAttributedString {
        if !hasFontAttribute() {
            let copy = NSMutableAttributedString(attributedString: self)
    ...
    fileprivate func copyWithHighlightedColor() -> NSAttributedString {
    ...
    fileprivate func lines(for width: CGFloat) -> [CTLine] {
    ...
    fileprivate func text(for lineRef: CTLine) -> NSAttributedString {
    ...
    fileprivate func boundingRect(for width: CGFloat) -> CGRect {
