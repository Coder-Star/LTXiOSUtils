...
public extension TxExtensionWrapper where Base: UIFont {

    /// 粗体
    /// - Parameter fontName: 字体名称，为空时使用系统字体，默认为空
    /// - Parameter fontSize: 字体尺寸
    static func boldFont(name fontName: String = "", size fontSize: CGFloat) -> UIFont {
    ...
    ///   - fontSize: 字体尺寸
    static func italicFont(name fontName: String = "", size fontSize: CGFloat) -> UIFont {
    ...
    /// - Parameter fontName: 字体名称，为空时使用系统字体，默认为空
    /// - Parameter fontSize: 字体尺寸
    static func boldItalicFont(name fontName: String = "", size fontSize: CGFloat) -> UIFont {
        let matrix = CGAffineTransform(a: 1, b: 0, c: CGFloat(tanf(15 * Float.pi / 180)), d: 1, tx: 0, ty: 0)
        var tempFontName = fontName
        if tempFontName.isEmpty {
            tempFontName = UIFont.systemFont(ofSize: fontSize).fontName
